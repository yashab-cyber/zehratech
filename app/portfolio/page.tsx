    ...
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 mb-3 sm:mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-6 sm:mt-8 px-4 sm:px-0">
            ...
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 inline-block mr-2" fill="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mb-20">
          <motion.div
            ...
            className="card"
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-neon-blue mb-4 sm:mb-6">About Me</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
              {skills.map((skill, index) => (
                <motion.div
                  ...
                  className="card text-center hover:border-neon-blue/70 p-3 sm:p-4"
                >
                  <p className="text-gray-300 font-medium text-xs sm:text-sm md:text-base">{skill}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              {workshops.map((workshop, index) => (
                <motion.div
                  ...
                  className="card"
                >
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3">{workshop.title}</h3>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 sm:px-3 py-1 bg-neon-blue/20 text-neon-blue text-xs sm:text-sm rounded-full border border-neon-blue/30"
                      >
                        {tech}
                      </span>
                    ))}
              ...
              {certificates.map((cert, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-lg mb-4">
                    <div className="relative h-48 sm:h-64 md:h-80 bg-dark-700">
                      <Image
                        src={cert.image}
                        alt={cert.title}
                        fill
        ...
        >
          ...
          <Link href="/contact" className="btn-primary inline-block text-sm sm:text-base">
            Get in Touch
          </Link>
        </motion.div>
      </div>
