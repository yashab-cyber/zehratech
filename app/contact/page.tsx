        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">contact@zehratech.in</p>
                    <p className="text-gray-400">yashab@zehratech.in</p>
                  </div>
                </div>
            ...
            <div className="card">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="flex-1 bg-dark-700 hover:bg-dark-600 border border-gray-700 hover:border-neon-blue/50 rounded-lg p-4 transition-all duration-300 text-center"
                >
            ...
            <div className="card bg-gradient-to-br from-neon-blue/10 to-neon-purple/10 border-neon-blue/30">
              <h2 className="text-2xl font-bold text-white mb-4">💡 Quick Tip</h2>
